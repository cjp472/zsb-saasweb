	...
	effects : {
        ...
        *getActivityList({ payload },{ call, put ,select }){
            ...
            let params = {
                ...
                orgId: payload && payload.params.attrOrgId || '',
                name: payload && payload.params.attrName || '',
                status: payload && payload.params.attrStatus || '',
            }
        ...
        *updateActivityStatus({ payload },{ call, put, select }){
            ...
            if( ret && ret.errorCode == '9000' ){
                let params = {
                    pageSize   : model.attrPageSize,
                    pageIndex  : model.attrPageIndex,
                    orgId      : model.attrOrgId,
                    name       : model.attrName,
                    status     : model.attrStatus,
                }
                yield put({
                    type : 'getActivityList',
                    payload : {
