            ...
            if(ret && ret.errorCode == '9000'){
                ...
                if(step == 3){
                    let forthStepBackgroundImg = [{
                        uid : -1 ,
                        url : !!ret.bgimg ? ret.bgimg : '//img.ishanshan.com/gimg/img/5d8629ed4cbfbc3da826e1233f723ec5',
                        name : '背景图',
                        thumbUrl : !!ret.bgimg ? ret.bgimg : '//img.ishanshan.com/gimg/img/5d8629ed4cbfbc3da826e1233f723ec5',
                    }];
                    let forthStepLogoImg = [{
                        uid : -2 ,
                        url : ret.logoimg ? ret.logoimg : '//img.ishanshan.com/gimg/img/f204fd8affff8cdb30b68554143ef4f5',
                        name : 'logo图',
                        thumbUrl : ret.logoimg ? ret.logoimg : '//img.ishanshan.com/gimg/img/f204fd8affff8cdb30b68554143ef4f5',
                    }]
                    yield put({
                        type:'updateState',
                        payload:{
