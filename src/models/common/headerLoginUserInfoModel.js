...
} from '../../services/common/mainLayoutService';
//顶部导航-右侧功能按钮
export default {
    ...
    state: {
        userImg: '//img.ishanshan.com/gimg/img/7b9f12699580bafa04d3dc44333b85b0',
        userName: '',
        ...
        *'queryUserImg'({ payload }, { call, put, select }) {
          ...
          if( ret && ret.errorCode == 9000 ){
              yield put({
                type: 'updateState',
                payload : {
                    userImg: ret.headImgUrl||'//img.ishanshan.com/gimg/img/7b9f12699580bafa04d3dc44333b85b0',
