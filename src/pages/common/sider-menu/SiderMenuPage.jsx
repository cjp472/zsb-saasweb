...
function SiderMenuPage({dispatch, siderMenuModel, systemInitModel}) {
    ...
    let {versionInfo} = systemInitModel;
    ...
    function changeVersionVisible() {
        dispatch({
            type: 'systemInitModel/changeVersionInfoVisible',
        });
    }
...
function mapStateToProps({ siderMenuModel, systemInitModel }) {
    return { siderMenuModel, systemInitModel };
}
