...
import { getAccountCardDetail , createAccountCard , updateAccountCard } from '../../../services/system/account-card/accountCardService';
import { getDictByKey } from '../../../services/common/dictService';
...
export default {
  ...
  effects: {
      ...
      *initDict({ payload } , { put , call , select }){
          let { ret } = yield call(getDictByKey, parse({dictkey: 'payment'}));
  ...
  reducers: {
      ...
      onClose(state, action) {
          return { ...state, visible : false , loading : false , formData : {} , selectValue : undefined }
      },
