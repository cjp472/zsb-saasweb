...
function MicroModuleFormComponent ({
    ...
    let _disabled = moduleAllDataSource && moduleAllDataSource.isHq === 1 && moduleInstId != undefined;
    ...
    return (
        <PageModal
           ...
           footer={[
                ...
                <Button type="primary" loading={loading} disabled={_disabled}>提交</Button>
                </Popconfirm>,
