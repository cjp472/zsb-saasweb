            ...
            <div className={styles.phoneBackground}>
                <div className="actualContent">
                    ...
                    <div className={styles.setOption}>
                        ...
                        <p className={styles.actLabel}>
                            <span>
                                <Icon type='location' className={styles.generalIconStyle} /> {/*location*/}
                            </span>活动地址：{params.address || '暂无地址'}
                        </p>
                        <p className={styles.actLabel}>
                            <span><Icon type='time1' className={styles.generalIconStyle} /></span>  {/*time1*/}
                            <span>活动时间：{moment(params.activityStartTime).format('YYYY-MM-DD HH:mm:ss') || ''} 至 { moment(params.activityEndTime).format('YYYY-MM-DD HH:mm:ss') || ''}</span>
                        </p>
                        ...
                        <p className={styles.actLabel}>
                            <span>
                                <span><Icon type='moneynew' className={styles.generalIconStyle} /> </span>
                            </span>报名缴费：
                            {
                                params.classCus && params.materialFee ?
                                    <span>
                                        {params.classCus ? `消耗课时 ${params.classCus} 节` : '0节'}&nbsp;&nbsp;
                                        {params.materialFee ? `物料费 ${params.materialFee} 元` : '0元'}
                                    </span>
                                    :
                                params.classCus ?
                                    <span>
