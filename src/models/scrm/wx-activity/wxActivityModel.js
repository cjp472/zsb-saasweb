	...
	effects : {
        ...
        *showActivityUrl({ payload },{ call, put, select }){
			if( !!window._init_data.firstOrg ){
                ...
                let urlOrgId = window._current_user_info && window._current_user_info.orgId || '';
        ...
        *confirmAddWxActivity({ payload },{ call, put, select }){
            ...
            let formData = {
                ...
                activityCover,
                activityDetail,
                orgIds: values.orgIds || window._current_user_info && window._current_user_info.orgId,
                name            : values.name,
                sort            : values.sort,
        ...
        *exportSuccess({ payload },{ call, put, select }){
            let wxActivityModel = yield select( state => state.wxActivityModel );
            let params = {
                orgId      : wxActivityModel.successOrgId || window._current_user_info.orgId,
                status     : wxActivityModel.applyStatus,
                activityId : wxActivityModel.activityId,
            }
