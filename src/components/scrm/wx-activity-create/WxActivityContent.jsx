    ...
    function handleOnSubmit() {
        validateFieldsAndScroll((err, values) => {
            ...
            if (data.form_activity_cancel_time) {
                ...
                params.cancelTime = moment(m).format('YYYY-MM-DD HH:mm:ss');
            }
            ...
            params.orgIds = window._current_user_info && window._current_user_info.orgId || '';
            ...
            <Form style={{ textAlign: 'left' }}>
                <FormItem {...formItemLayout} label="活动名称" style={{ textAlign: 'left' }}>
                    {getFieldDecorator('form_activity_name', {
                        ...
                        <Input style={{ width: '100%' }} size='default' placeholder='请输入活动名称' />
                    )}
                </FormItem>
                <FormItem
                    { ...formItemLayout}
                ...
                <FormItem
                    { ...formItemLayout}
                    label="轮播图"
                    help="轮播图, 最多5张; 支持png、jpeg、gif格式的图片, 建议宽高 750*400px; 图片大小小于2M"
                >
                ...
                >
                    {getFieldDecorator('form_activity_number', {
                        ...
                        <InputNumber disabled={attrModify || false} min={1} style={{ width: '100%' }} size='default' placeholder='请输入活动人数' />
                    )}
                </FormItem>
                <FormItem
                    { ...formItemLayout }
                ...
                >
                    {getFieldDecorator('form_activity_cancel_time', {
                        ...
                        <DatePicker style={{ width: '100%' }} size='default' showTime format="YYYY-MM-DD HH:mm:ss" placeholder='允许用户取消报名的最晚时间' />
                    )}
                </FormItem>
                ...
                >
                    {getFieldDecorator('form_activity_participate_list', {
                        initialValue: String(attrModifyData.participate || 1) || '0',
                        rules: [
                ...
                >
                    {getFieldDecorator('form_activity_waiting_list', {
                        initialValue: String(attrModifyData.waiting || 1) || '1',
                        rules: [
                    ...
                    <Form>
                        ...
                        >
                            {getFieldDecorator('form_activity_money_number', {
                                ...
                                <InputNumber precision={2} step={0.01} min={0.01} style={{ width: '100%' }} size='default' placeholder='请输大于0的金额' />
                            )}
                        </FormItem>
                    </Form>
                    :
            ...
            <Form>
                ...
                >
                    {getFieldDecorator('form_activity_share_intro', {
                        ...
                        <Input style={{ width: '100%' }} size='default' placeholder='请输入分享简介（1～80个字）' />
                    )}
                </FormItem>
                <FormItem
                    { ...formItemLayout }
            ...
            footer={[
                <Popconfirm title="确定要保存吗?" onConfirm={handleOnSubmit} placement="bottomRight" >
                    <Button
                        type="primary"
                        loading={false}
                        disabled={attrModify ? attrModifyData && attrModifyData.isHq === 1 : false}
                    >提交</Button>
                </Popconfirm>,
