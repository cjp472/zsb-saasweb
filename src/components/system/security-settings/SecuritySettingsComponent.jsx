...
function SecuritySettingsComponent({
    ...
    let AlertModalProps = {
        ...
        footer : [
            <Button key="cancel" type="ghost" onClick={closeSettingModal}> 取 消 </Button>,
            <Button key="submit" type="primary"
                    style={{marginLeft:'10px'}}
                    onClick={commitSettingModal}
                > 提 交 </Button>
        ],
                ...
                >
                    { getFieldDecorator('FirstVal' , {
                        ...
                        <div style = {{ display : 'flex' , flexWrap : 'nowrap' , justifyContent : 'space-between' }}>
                            <Input size = 'default' style = {{ width : '70%' , marginRight : 20 }} />
                ...
                <FormItem
                    ...
                    >
                        { getFieldDecorator('SecondTel' , {
                            ...
                            <Input size = 'default' style = {{ width : '100%' }} onChange={ (e) => changeSecondTel(e) }/>
                        )}
                    </FormItem>
                    <FormItem
                        { ...formItemLayout1 }
...
//    }
    return(
        <div >
            { phoneNumState == 10000 ?
                <div>
                    <p style={{marginLeft:'38px',marginBottom:'20px'}}>您还未设置安全认证手机号！此号码极其重要，将保障账号、资金等安全。</p>
                    <Button type="primary" style={{marginLeft:'38px'}} onClick={settingBtn}>设置安全认证手机</Button>
                </div>
                :
                phoneNumState == 9000 ?
                <div>
                    <Form>
                        ...
                        <Button size="large" type="primary" style={{marginLeft:'38px'}} onClick={tiedupFun}>改绑</Button>
                    </Form>
                </div>
                :
                null
                ...
                <Form>
                    ...
                    >
                        { getFieldDecorator('settingTel' , {
                            ...
                            <Input size = 'default' style = {{ width : '100%' }} onChange={ (e) => changeSettingTel(e) }/>
                        )}
                    </FormItem>
                    <FormItem
                        { ...formItemLayout1 }
