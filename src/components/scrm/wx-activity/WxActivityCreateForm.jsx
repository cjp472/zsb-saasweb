    ...
    return(
       <Modal
            ...
            footer    = {[
                        ...
                        <Button key="confirmAddClassPackage" type="primary" disabled={activityInfo && activityInfo.isHq === 1} onClick = { confirmAddWxActivityAction } >保存</Button>
                      ]}
        >
                ...
                <Form>
                    ...
                    >
                        { getFieldDecorator('htmlContent',{
                            initialValue : activityInfo.htmlContent || undefined,
                        })(
                            <RichEditor  />
                        )}
                    </FormItem>
