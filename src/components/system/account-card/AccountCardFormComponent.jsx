    ...
    return (
        <Modal
			...
			footer = {[
				...
				<Button key = "accountConfirmAction" type = 'primary' onClick = { onSaveClick } style = {{ marginLeft : '20px' }} >保存</Button>
			]}
        >
                   ...
                   { selectValue == 'bank' ?
                    ...
                    >
                        {getFieldDecorator('rate', {
                            ...
                            <Input style = {{ width : '100%' }} size='default' addonAfter = '%' placeholder = '请输入费率[0,100),可精确到小数点后3位，不填则默认0'/>
                        )}
                    </FormItem>
